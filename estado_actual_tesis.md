...
La adquisición DIA definitiva aún no comenzó, no fue analizada y no fue presentada al tutor como resultado. Sin embargo, OE2 tuvo avance metodológico preliminar interno: se preparó y evaluó un estándar multiespecie tipo Frey con WISH/humano, E. coli y S. cerevisiae, primero por DDA, para controlar mezcla, preparación, búsqueda y cuantificación antes de trasladar la lógica a DIA. Este material no debe tratarse como resultado oficial del TFDC sin una decisión explícita posterior.
...
No hay set biológico definitivo control vs EMB para DIA, ni datos crudos DIA, ni matriz cuantitativa final, ni listas de proteínas diferenciales del TFDC, ni análisis funcional, ni comparación formal DIA vs DDA. Tampoco hay análisis DIA reportable ni resultado DIA presentado al tutor. El antecedente DDA del laboratorio (~192 proteínas diferenciales, ~20% del proteoma detectado) es referencia comparativa para OE6, no resultado del TFDC.
