...
- Decisiones de plataforma experimental y su razón, en la medida en que consten en las fuentes: placas de 24 pocillos cell culture treated a 1 mL por pocillo, usadas porque eran las disponibles; las de 96 fallan por aireación insuficiente a las velocidades de agitación disponibles. Corrección 2026-06-30: la versión previa decía erróneamente "placas de 24 pocillos no tratadas" y atribuía adhesión celular a las placas tratadas; esa formulación queda invalidada por indicación directa de Nazareno. También queda cerrado el inóculo de trabajo a OD 0.1 (OD 0.001 y 0.01 no inician crecimiento detectable en CGXII), medio CGXII con elementos traza y DHB como componentes necesarios para crecimiento confiable, control negativo de MIC con EMB a alta concentración en lugar de Triton X-100 porque el EMB es bacteriostático y el control negativo debe aproximar la OD del inóculo inicial, no cero.
